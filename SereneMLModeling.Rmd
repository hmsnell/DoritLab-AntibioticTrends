...
iqvia13_1 <- read.csv("~/Desktop/iqvia13_1.csv")
iqvia13_2 <- read.csv("~/Desktop/iqvia13_2.csv")
iqvia13_3 <- read.csv("~/Desktop/iqvia13_3.csv")
iqvia13_4 <- read.csv("~/Desktop/iqvia13_4.csv")
iqvia13_5 <- read.csv("~/Desktop/iqvia13_5.csv")

iqvia14_1 <- read.csv("~/Desktop/iqvia14_1.csv")
iqvia14_2 <- read.csv("~/Desktop/iqvia14_2.csv")
iqvia14_3 <- read.csv("~/Desktop/iqvia14_3.csv")
iqvia14_4 <- read.csv("~/Desktop/iqvia14_4.csv")
iqvia14_5 <- read.csv("~/Desktop/iqvia14_5.csv")

iqvia15_1 <- read.csv("~/Desktop/iqvia15_1.csv")
iqvia15_2 <- read.csv("~/Desktop/iqvia15_2.csv")
iqvia15_3 <- read.csv("~/Desktop/iqvia15_3.csv")
iqvia15_4 <- read.csv("~/Desktop/iqvia15_4.csv")
iqvia15_5 <- read.csv("~/Desktop/iqvia15_5.csv")

iqvia16_1 <- read.csv("~/Desktop/iqvia16_1.csv")
iqvia16_2 <- read.csv("~/Desktop/iqvia16_2.csv")
iqvia16_3 <- read.csv("~/Desktop/iqvia16_3.csv")
iqvia16_4 <- read.csv("~/Desktop/iqvia16_4.csv")
iqvia16_5 <- read.csv("~/Desktop/iqvia16_5.csv")
...
combinediqvia <- rbind(iqvia1, iqvia2, iqvia3, iqvia4, iqvia5, 
                       iqvia13_1, iqvia13_2, iqvia13_3, iqvia13_4, iqvia13_5, 
                       iqvia14_1, iqvia14_2, iqvia14_3, iqvia14_4, iqvia14_5,
                       iqvia15_1, iqvia15_2, iqvia15_3, iqvia15_4, iqvia15_5,
                       iqvia16_1, iqvia16_2, iqvia16_3, iqvia16_4, iqvia16_5)
